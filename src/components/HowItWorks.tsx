import { Check, FileText, Search, BarChart, TrendingUp } from 'lucide-react'

const steps = [
  { icon: FileText, title: 'Project Listing', description: 'Vetted partners list sustainable energy projects' },
  ...
  { icon: BarChart, title: 'Progress Monitoring', description: 'Track project development in real-time' },
